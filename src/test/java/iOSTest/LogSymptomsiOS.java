...
//	        cap.setCapability("usePreinstalledWDA", "true");
	        cap.setCapability("app", "/Users/olufemiomeiza/Downloads/Runner-11.app");
...
//	    	Enter Symptom name
	    	WebElement symptomName=driver.findElements(By.className("XCUIElementTypeTextField")).get(2);
//	    	symptomName.click();
	    	symptomName.sendKeys("Headache");
...
//			}
////	    	Select severity
//	    	WebElement severity=driver.findElement(AppiumBy.iOSNsPredicateString("value == \'0%\'"));
//	    	severity.sendKeys("0.3%");
//	    	System.out.println(severity.getAttribute("value"));
//	    	
//			Thread.sleep(2000);
...
//	    	Set triggers
	    	...
	    	WebElement doneButton = driver.findElement(AppiumBy.accessibilityId("Done"));
	    	doneButton.click();	 
...
//	    	Set Alleviating factors
	    	...
	    	WebElement done1Button = driver.findElement(AppiumBy.accessibilityId("Done"));
	    	done1Button.click();	 
			driver.navigate().back();

//	    	Set date
	    	driver.findElements(By.className("XCUIElementTypeImage")).get(3).click();
//	    	driver.findElement(AppiumBy.accessibilityId("19, Wednesday, June 19, 2024")).click();
